const theme = {
    techColors:{
        disabled: 'linear-gradient(-90deg, rgb(145, 147, 170), rgb(125, 130, 168))',
        all: 'linear-gradient(to right, rgb(186, 104, 200), rgb(156, 39, 176))',
        ...
        net: 'linear-gradient(-90deg, rgb(63, 197, 230), rgb(79, 164, 253))',
        ...
        testing: 'linear-gradient(-90deg, rgb(137, 219, 84), rgb(101, 175, 53))',
        ...
        blockchain: 'linear-gradient(-90deg, rgb(171, 71, 188), rgb(106, 27, 154))',
        security: 'linear-gradient(-90deg, rgb(83, 109, 254), rgb(13, 71, 161))',
        data: 'linear-gradient(-90deg, rgb(0, 150, 136), rgb(0, 121, 107))',
    ...
    shadows: {
        card: 'rgba(0, 0, 0, 0.05) 0px 2px 2px 0px, rgba(0, 0, 0, 0.04) 0px 1px 5px 0px',
        cardHover:'rgba(0, 0, 0, 0.07) 0px 4px 4px 0px, rgba(0, 0, 0, 0.06) 0px 3px 7px 0px'
    },
    breakpoints: {
        xs: '360px',
        s: '500px',
...
const lightModeTheme = {
    colors: {
        ...
        shadow: 'rgba(0, 0, 0, 0.05) 0px 2px 2px 0px, rgba(0, 0, 0, 0.04) 0px 1px 5px 0px'
    }
}
const darkModeTheme = {
    colors: {
