...
const locationsArray = ['Junior', 'Mid', 'Senior']

const DialogComponent = ({params, setDialogOpen, dialogOpen}) =>{ 
    
    const [value, setValue] = React.useState([params.from || 0, params.to || 50000]);
    ...
    const [expLvl, setExpLvl] = useState(params.exp_lvl)
        ...
        >
            <Container>
                ...
                <Wrapper>
                    ...
                    {locationsArray.map((lvl)=>(
                        <ButtonWrapper>
                            <CustomButton
                                onclick={()=>setExpLvl(lvl.toLowerCase())}
                ...
                <BottomWrapper>
                    ...
                    <StyledLink 
                        to={url({...params, exp_lvl: expLvl, from: value[0], to: value[1]===50000 ? null : value[1] })}
                        onClick={onClose}
                    >
                        <PinkButton>
                            Show offers    
