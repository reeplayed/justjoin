...
const createHTMLMapMarker = history => {
  ...
  CustomMarker.prototype.onLabelActiveMapRemove = function() {
    ...
    if (vertical + horizontal) {
      var point = new global.google.maps.LatLng(
        ...
        switch (sort) {
          case 'sal-down':
            return a.salary_from > b.salary_from
              ? 1
              : a.salary_from === b.salary_from
              ? a.salary_to > b.salary_to
                ? 1
                : -1
              : -1;
          case 'sal-up':
            return a.salary_to < b.salary_to
              ? 1
              : a.salary_to === b.salary_to
              ? a.salary_from < b.salary_from
                ? 1
      ...
      this.offers.forEach(item => {
        ...
        htmlEl.innerHTML = `<div class='logo_wrapper'>
                                ...
                                <div class='item_info_container'>
                                  ...
                                  <span class='item_info_salary'>${item.salary_from +
                                    ' - ' +
                                    item.salary_to} PLN</span>
                                  <span class='item_info_name'>${
                                    item.company_name
                                  }</span>
                                </div>`;
