  ...
  return (
    ...
    >
      <Container>
        ...
        <BottomWrapper>
          <StyledLink to={url({ ...params, exp_lvl: null })} onClick={onClose}>
            <CustomButton padding="8px 30px">Clear filters</CustomButton>
          </StyledLink>
    ...
    <React.Fragment>
      <ButtonWrapper>
        <CustomButton
          ...
          active={params.exp_lvl || params.from || params.to}
          icon
        >
          More Filters
        </CustomButton>
