...
const locationsArray = ['Warszawa', 'Łódź', 'Poznań', 'Kraków', 'Zielona Góra', 'Białystok', 'Wrocław']
                ...
                <Container>
                    ...
                    <Wrapper>
                        {locationsArray.map((loc)=>(
                            <ItemWrapper>
                                <CustomButton
                                    onclick={()=>setLocation(stringFormat(loc))}
                                    active={location ? stringFormat(loc)===location : stringFormat(loc)===params.location}
                                    padding='8px 30px'
                                >
                                    {loc}
                                </CustomButton>
                    ...
                    <BottomWrapper>
                        ...
                        <StyledLink 
                            to={url({...params, location : location || params.location})}
                            onClick={onClose}
                        >
                            <PinkButton>
                                Show offers    
